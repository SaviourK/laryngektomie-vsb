...
var listImageArea = carouselContainer.querySelector('.next-list');
var listOfImages = listImageArea.querySelectorAll('img');
var currentImage = carouselContainer.querySelector('.current-image');
var arrowLeft = carouselContainer.querySelector('.arrow-left');
var arrowRight = carouselContainer.querySelector('.arrow-right');
